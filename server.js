...
const recipeRoutes = require('./routes/recipe-routes.js');  // Routes for recipe-related API endpoints
...
app.use('/recipe', recipeRoutes);         // All /recipe routes will be handled by recipeRoutes
